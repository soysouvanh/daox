...
impl OrderItems {
    ...
    pub fn stream_all<'e, E: sqlx::Executor<'e, Database = sqlx::Postgres> + 'e>(
        ...
        let query = r#"SELECT "order_id", "product_id", "quantity" FROM "order_items" ORDER BY "order_id" ASC, "product_id" ASC LIMIT $1"#;
    ...
    pub async fn insert<'e, E: sqlx::Executor<'e, Database = sqlx::Postgres>>(
        ...
        let query = r#"INSERT INTO "order_items" ("order_id", "product_id", "quantity") VALUES ($1, $2, $3)"#;
    ...
    >(
        ...
        let query_str = r#"UPDATE "order_items" SET "quantity" = $1 WHERE "order_id" = $2 AND "product_id" = $3"#;
    ...
    >(
        ...
        if patch.quantity.is_some() {
            set_clauses.push(format!("\"quantity\" = ${}", _param_idx));
            _param_idx += 1;
        }
        ...
        query_str.push_str(&format!(" WHERE \"order_id\" = ${}", _param_idx));
        _param_idx += 1;
        query_str.push_str(&format!(" AND \"product_id\" = ${}", _param_idx));
        _param_idx += 1;
