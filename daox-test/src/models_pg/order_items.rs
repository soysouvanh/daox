...
impl OrderItems {
    ...
    pub async fn list_paginated<'e, E: sqlx::Executor<'e, Database = sqlx::Postgres>>(executor: E, order_by: &str, page: u32, page_size: u32) -> sqlx::Result<Vec<Self>> {
        ...
        let query = format!("SELECT * FROM order_items ORDER BY {} LIMIT $1 OFFSET $2", order_by);
    ...
    pub async fn get_by_pk<'e, E: sqlx::Executor<'e, Database = sqlx::Postgres>>(executor: E, order_id: &i64, product_id: &i64) -> sqlx::Result<Option<Self>> {
        let query = "SELECT * FROM order_items WHERE order_id = $1 AND product_id = $2";
    ...
    pub async fn exists_by_pk<'e, E: sqlx::Executor<'e, Database = sqlx::Postgres>>(executor: E, order_id: &i64, product_id: &i64) -> sqlx::Result<bool> {
...
impl OrderItems {
    ...
    pub async fn update_partial_by_pk<'e, E: sqlx::Executor<'e, Database = sqlx::Postgres>>(executor: E, order_id: &i64, product_id: &i64, patch: &OrderItemsPatch) -> sqlx::Result<u64> {
        let mut query_builder: sqlx::QueryBuilder<sqlx::Postgres> = sqlx::QueryBuilder::new("UPDATE order_items SET ");
