...
impl CompTypesView {
    ...
    pub async fn approximate_count<'e, E: sqlx::Executor<'e, Database = sqlx::Postgres>>(
        ...
        let query = r#"SELECT reltuples::bigint FROM pg_class WHERE relname = 'comp_types_view'"#;
    ...
    pub fn stream_all<'e, E: sqlx::Executor<'e, Database = sqlx::Postgres> + 'e>(
        ...
        let query = r#"SELECT "f_blob", "f_bool", "f_date", "f_datetime", "f_decimal", "f_double", "f_float", "f_int", "f_json", "f_text", "f_timestamp", "f_varchar", "id" FROM "comp_types_view" ORDER BY "id" ASC LIMIT $1"#;
