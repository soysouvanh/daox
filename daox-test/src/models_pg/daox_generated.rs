...
impl CompTypesMetadata {
    ...
    pub async fn delete_many_by_id<'e, E: sqlx::Executor<'e, Database = sqlx::Postgres>>(executor: E, ids: &[i64]) -> sqlx::Result<u64> {
...
impl Configurations {
    ...
    pub async fn delete_many_by_id<'e, E: sqlx::Executor<'e, Database = sqlx::Postgres>>(executor: E, ids: &[i32]) -> sqlx::Result<u64> {
        if ids.is_empty() { return Ok(0); }
...
impl Currencies {
    ...
    pub async fn get_by_code<'e, E: sqlx::Executor<'e, Database = sqlx::Postgres>>(executor: E, code: &String) -> sqlx::Result<Option<Self>> {
    ...
    pub async fn exists_by_code<'e, E: sqlx::Executor<'e, Database = sqlx::Postgres>>(executor: E, code: &String) -> sqlx::Result<bool> {
    ...
    pub async fn delete_many_by_code<'e, E: sqlx::Executor<'e, Database = sqlx::Postgres>>(executor: E, ids: &[String]) -> sqlx::Result<u64> {
        if ids.is_empty() { return Ok(0); }
    ...
    pub async fn update_partial_by_code<'e, E: sqlx::Executor<'e, Database = sqlx::Postgres>>(executor: E, code: &String, patch: &CurrenciesPatch) -> sqlx::Result<u64> {
...
impl ProductMetadata {
    ...
    pub async fn get_by_id<'e, E: sqlx::Executor<'e, Database = sqlx::Postgres>>(executor: E, id: &Vec<u8>) -> sqlx::Result<Option<Self>> {
        let query = "SELECT \"attributes\", \"category\", \"id\", \"raw_data\" FROM product_metadata WHERE \"id\" = $1";
        sqlx::query_as::<_, Self>(query).bind(id).fetch_optional(executor).await
    }

    pub async fn exists_by_id<'e, E: sqlx::Executor<'e, Database = sqlx::Postgres>>(executor: E, id: &Vec<u8>) -> sqlx::Result<bool> {
        let query = "SELECT 1 FROM product_metadata WHERE \"id\" = $1 LIMIT 1";
        let exists: Option<(i32,)> = sqlx::query_as(query).bind(id).fetch_optional(executor).await?;
        Ok(exists.is_some())
    }

    pub async fn list_by_cursor<'e, E: sqlx::Executor<'e, Database = sqlx::Postgres>>(executor: E, last_id: &Vec<u8>, limit: u32) -> sqlx::Result<Vec<Self>> {
    ...
    pub async fn delete_many_by_id<'e, E: sqlx::Executor<'e, Database = sqlx::Postgres>>(executor: E, ids: &[Vec<u8>]) -> sqlx::Result<u64> {
        if ids.is_empty() { return Ok(0); }
    ...
    pub async fn update_partial_by_id<'e, E: sqlx::Executor<'e, Database = sqlx::Postgres>>(executor: E, id: &Vec<u8>, patch: &ProductMetadataPatch) -> sqlx::Result<u64> {
...
impl UserRoles {
    ...
    pub async fn get_by_role_name_and_user_id<'e, E: sqlx::Executor<'e, Database = sqlx::Postgres>>(executor: E, role_name: &String, user_id: i64) -> sqlx::Result<Option<Self>> {
    ...
    pub async fn exists_by_role_name_and_user_id<'e, E: sqlx::Executor<'e, Database = sqlx::Postgres>>(executor: E, role_name: &String, user_id: i64) -> sqlx::Result<bool> {
    ...
    pub async fn update_partial_by_role_name_and_user_id<'e, E: sqlx::Executor<'e, Database = sqlx::Postgres>>(executor: E, role_name: &String, user_id: i64, patch: &UserRolesPatch) -> sqlx::Result<u64> {
