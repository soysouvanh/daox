...
impl Currencies {
    ...
    pub async fn get_by_pk<'e, E: sqlx::Executor<'e, Database = sqlx::Sqlite>>(executor: E, code: &String) -> sqlx::Result<Option<Self>> {
    ...
    pub async fn exists_by_pk<'e, E: sqlx::Executor<'e, Database = sqlx::Sqlite>>(executor: E, code: &String) -> sqlx::Result<bool> {
...
impl Currencies {
    ...
    pub async fn insert_batch<'e, E: sqlx::Executor<'e, Database = sqlx::Sqlite>>(executor: E, items: &[Self]) -> sqlx::Result<u64> {
        ...
        let mut query_builder: sqlx::QueryBuilder<sqlx::Sqlite> = sqlx::QueryBuilder::new("INSERT INTO currencies (code, name) ");
    ...
    pub async fn delete_many_by_pk<'e, E: sqlx::Executor<'e, Database = sqlx::Sqlite>>(executor: E, ids: &[String]) -> sqlx::Result<u64> {
        ...
        let mut query_builder: sqlx::QueryBuilder<sqlx::Sqlite> = sqlx::QueryBuilder::new("DELETE FROM currencies WHERE code IN ");
        query_builder.push("(");
...
impl Currencies {
    ...
    pub async fn update_partial_by_pk<'e, E: sqlx::Executor<'e, Database = sqlx::Sqlite>>(executor: E, code: &String, patch: &CurrenciesPatch) -> sqlx::Result<u64> {
        let mut query_builder: sqlx::QueryBuilder<sqlx::Sqlite> = sqlx::QueryBuilder::new("UPDATE currencies SET ");
