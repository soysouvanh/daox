...
impl Users {
    ...
    pub async fn get_by_pk<'e, E: sqlx::Executor<'e, Database = sqlx::Sqlite>>(executor: E, id: &i64) -> sqlx::Result<Option<Self>> {
    ...
    pub async fn exists_by_pk<'e, E: sqlx::Executor<'e, Database = sqlx::Sqlite>>(executor: E, id: &i64) -> sqlx::Result<bool> {
    ...
    pub async fn list_by_cursor<'e, E: sqlx::Executor<'e, Database = sqlx::Sqlite>>(executor: E, last_id: &i64, limit: u32) -> sqlx::Result<Vec<Self>> {
    ...
    pub async fn exists_by_last_name_and_first_name<'e, E: sqlx::Executor<'e, Database = sqlx::Sqlite>>(executor: E, last_name: &String, first_name: &Option<String>) -> sqlx::Result<bool> {
    ...
    pub async fn list_by_last_name_and_first_name<'e, E: sqlx::Executor<'e, Database = sqlx::Sqlite>>(executor: E, last_name: &String, first_name: &Option<String>) -> sqlx::Result<Vec<Self>> {
    ...
    pub fn stream_by_last_name_and_first_name<'e, E: sqlx::Executor<'e, Database = sqlx::Sqlite> + 'e>(executor: E, last_name: &String, first_name: &Option<String>) -> impl futures::Stream<Item = sqlx::Result<Self>> + 'e {
        let query = "SELECT * FROM users WHERE last_name = ? AND first_name = ?";
        sqlx::query_as::<_, Self>(query).bind(last_name.clone()).bind(first_name.clone()).fetch(executor)
    }

    /// Checks if a record exists using the `sqlite_autoindex_users_1` index.
    /// 
    /// **Performance:** Extremely fast, uses `SELECT 1 ... LIMIT 1`.
    ...
    /// Retrieves a single record using the unique `sqlite_autoindex_users_1` index.
...
impl Users {
    ...
    pub async fn insert_batch<'e, E: sqlx::Executor<'e, Database = sqlx::Sqlite>>(executor: E, items: &[Self]) -> sqlx::Result<u64> {
        ...
        let mut query_builder: sqlx::QueryBuilder<sqlx::Sqlite> = sqlx::QueryBuilder::new("INSERT INTO users (email, first_name, last_name, status, created_at) ");
    ...
    pub async fn upsert<'e, E: sqlx::Executor<'e, Database = sqlx::Sqlite>>(&self, executor: E) -> sqlx::Result<u64> {
        let query = "INSERT INTO users (email, first_name, last_name, status, created_at) VALUES (?, ?, ?, ?, ?) ON CONFLICT (email) DO UPDATE SET email = EXCLUDED.email, first_name = EXCLUDED.first_name, last_name = EXCLUDED.last_name, status = EXCLUDED.status, created_at = EXCLUDED.created_at";
        let result = sqlx::query(query)
            .bind(&self.email)
            .bind(&self.first_name)
            .bind(&self.last_name)
    ...
    pub async fn delete_many_by_pk<'e, E: sqlx::Executor<'e, Database = sqlx::Sqlite>>(executor: E, ids: &[i64]) -> sqlx::Result<u64> {
        if ids.is_empty() { return Ok(0); }
        let mut query_builder: sqlx::QueryBuilder<sqlx::Sqlite> = sqlx::QueryBuilder::new("DELETE FROM users WHERE id IN ");
        query_builder.push("(");
    ...
    pub async fn update_by_last_name_and_first_name<'e, E: sqlx::Executor<'e, Database = sqlx::Sqlite>>(&self, executor: E) -> sqlx::Result<u64> {
    ...
    pub async fn delete_by_last_name_and_first_name<'e, E: sqlx::Executor<'e, Database = sqlx::Sqlite>>(executor: E, last_name: &String, first_name: &Option<String>) -> sqlx::Result<u64> {
    ...
    /// Updates records matching the `sqlite_autoindex_users_1` index.
    /// 
    /// **Warning:** This overwrites all columns (except the index columns) with the values from the current struct.
    pub async fn update_by_email<'e, E: sqlx::Executor<'e, Database = sqlx::Sqlite>>(&self, executor: E) -> sqlx::Result<u64> {
    ...
    /// Deletes records matching the `sqlite_autoindex_users_1` index.
    /// 
    /// Returns the number of affected rows.
...
impl Users {
    ...
    pub async fn update_partial_by_pk<'e, E: sqlx::Executor<'e, Database = sqlx::Sqlite>>(executor: E, id: &i64, patch: &UsersPatch) -> sqlx::Result<u64> {
