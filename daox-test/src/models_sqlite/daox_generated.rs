...
impl ActiveUsers {
    ...
    pub async fn insert<'e, E: sqlx::Executor<'e, Database = sqlx::Sqlite>>(&self, executor: E) -> sqlx::Result<u64> {
        let query = "INSERT INTO active_users (`email`, `first_name`, `id`, `last_name`) VALUES (?, ?, ?, ?)";
        let result = sqlx::query::<sqlx::Sqlite>(query).bind(&self.email).bind(&self.first_name).bind(&self.id).bind(&self.last_name).execute(executor).await?;
...
impl CompTypesMetadata {
    ...
    pub async fn get_by_id<'e, E: sqlx::Executor<'e, Database = sqlx::Sqlite>>(executor: E, id: i64) -> sqlx::Result<Option<Self>> {
    ...
    pub async fn exists_by_id<'e, E: sqlx::Executor<'e, Database = sqlx::Sqlite>>(executor: E, id: i64) -> sqlx::Result<bool> {
    ...
    pub async fn delete_by_id<'e, E: sqlx::Executor<'e, Database = sqlx::Sqlite>>(executor: E, id: i64) -> sqlx::Result<u64> {
...
impl ProductMetadata {
    ...
    pub async fn delete_by_id<'e, E: sqlx::Executor<'e, Database = sqlx::Sqlite>>(executor: E, id: &Vec<u8>) -> sqlx::Result<u64> {
...
impl UserRoles {
    ...
    pub async fn delete_by_role_name_and_user_id<'e, E: sqlx::Executor<'e, Database = sqlx::Sqlite>>(executor: E, role_name: &String, user_id: i64) -> sqlx::Result<u64> {
        let query = "DELETE FROM user_roles WHERE `role_name` = ? AND `user_id` = ?";
        let result = sqlx::query::<sqlx::Sqlite>(query).bind(role_name).bind(user_id).execute(executor).await?;
        Ok(result.rows_affected())
    }
    ...
    pub async fn list_by_user_id<'e, E: sqlx::Executor<'e, Database = sqlx::Sqlite>>(executor: E, user_id: i64) -> sqlx::Result<Vec<Self>> {
...
impl Users {
    ...
    pub async fn list_by_last_name_and_first_name<'e, E: sqlx::Executor<'e, Database = sqlx::Sqlite>>(executor: E, last_name: &String, first_name: &String) -> sqlx::Result<Vec<Self>> {
