...
impl OrderItems {
    ...
    pub async fn list_paginated<'e, E: sqlx::Executor<'e, Database = sqlx::Sqlite>>(
        ...
        let query = format!(
            "SELECT * FROM order_items ORDER BY {} LIMIT ? OFFSET ?",
            order_by
        );
    ...
    pub async fn get_by_pk<'e, E: sqlx::Executor<'e, Database = sqlx::Sqlite>>(
        executor: E,
        order_id: &i64,
        product_id: &i64,
    ...
    pub async fn exists_by_pk<'e, E: sqlx::Executor<'e, Database = sqlx::Sqlite>>(
        executor: E,
        order_id: &i64,
        product_id: &i64,
    ) -> sqlx::Result<bool> {
...
impl OrderItems {
    ...
    pub async fn insert_batch<'e, E: sqlx::Executor<'e, Database = sqlx::Sqlite>>(
        executor: E,
        items: &[Self],
    ) -> sqlx::Result<u64> {
        if items.is_empty() {
    ...
    pub async fn update_by_pk<'e, E: sqlx::Executor<'e, Database = sqlx::Sqlite>>(
        &self,
        executor: E,
    ) -> sqlx::Result<u64> {
    ...
    pub async fn delete_by_pk<'e, E: sqlx::Executor<'e, Database = sqlx::Sqlite>>(
        executor: E,
        order_id: &i64,
        product_id: &i64,
    ) -> sqlx::Result<u64> {
...
impl OrderItems {
    ...
    pub async fn update_partial_by_pk<'e, E: sqlx::Executor<'e, Database = sqlx::Sqlite>>(
        executor: E,
        order_id: &i64,
        product_id: &i64,
