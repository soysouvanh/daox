...
impl ProductMetadata {
    ...
    pub async fn get_by_pk<'e, E: sqlx::Executor<'e, Database = sqlx::MySql>>(executor: E, id: &Vec<u8>) -> sqlx::Result<Option<Self>> {
    ...
    pub async fn exists_by_pk<'e, E: sqlx::Executor<'e, Database = sqlx::MySql>>(executor: E, id: &Vec<u8>) -> sqlx::Result<bool> {
...
impl ProductMetadata {
    ...
    pub async fn insert_batch<'e, E: sqlx::Executor<'e, Database = sqlx::MySql>>(executor: E, items: &[Self]) -> sqlx::Result<u64> {
        ...
        let mut query_builder: sqlx::QueryBuilder<sqlx::MySql> = sqlx::QueryBuilder::new("INSERT INTO product_metadata (id, category, attributes, raw_data) ");
    ...
    pub async fn upsert<'e, E: sqlx::Executor<'e, Database = sqlx::MySql>>(&self, executor: E) -> sqlx::Result<u64> {
        let query = "INSERT INTO product_metadata (id, category, attributes, raw_data) VALUES (?, ?, ?, ?) ON DUPLICATE KEY UPDATE id = VALUES(id), category = VALUES(category), attributes = VALUES(attributes), raw_data = VALUES(raw_data)";
        let result = sqlx::query(query)
            .bind(&self.id)
            .bind(&self.category)
            .bind(&self.attributes)
    ...
    pub async fn delete_by_pk<'e, E: sqlx::Executor<'e, Database = sqlx::MySql>>(executor: E, id: &Vec<u8>) -> sqlx::Result<u64> {
    ...
    pub async fn delete_many_by_pk<'e, E: sqlx::Executor<'e, Database = sqlx::MySql>>(executor: E, ids: &[Vec<u8>]) -> sqlx::Result<u64> {
        if ids.is_empty() { return Ok(0); }
        let mut query_builder: sqlx::QueryBuilder<sqlx::MySql> = sqlx::QueryBuilder::new("DELETE FROM product_metadata WHERE id IN ");
        query_builder.push("(");
...
impl ProductMetadata {
    ...
    pub async fn update_partial_by_pk<'e, E: sqlx::Executor<'e, Database = sqlx::MySql>>(executor: E, id: &Vec<u8>, patch: &ProductMetadataPatch) -> sqlx::Result<u64> {
        let mut query_builder: sqlx::QueryBuilder<sqlx::MySql> = sqlx::QueryBuilder::new("UPDATE product_metadata SET ");
