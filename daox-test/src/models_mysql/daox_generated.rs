...
impl CompTypesMatView {
    ...
    pub async fn insert_batch<'e, E: sqlx::Executor<'e, Database = sqlx::MySql> + Clone>(executor: E, items: &[Self]) -> sqlx::Result<u64> {
...
impl CompTypesMetadata {
    ...
    pub async fn upsert<'e, E: sqlx::Executor<'e, Database = sqlx::MySql>>(&self, executor: E) -> sqlx::Result<u64> {
        let query = "INSERT INTO comp_types_metadata (`comp_types_id`, `f_blob`, `f_date`, `f_datetime`, `f_json`, `f_timestamp`) VALUES (?, ?, ?, ?, ?, ?) AS new_row ON DUPLICATE KEY UPDATE `comp_types_id` = new_row.`comp_types_id`, `f_blob` = new_row.`f_blob`, `f_date` = new_row.`f_date`, `f_datetime` = new_row.`f_datetime`, `f_json` = new_row.`f_json`, `f_timestamp` = new_row.`f_timestamp`";
        let result = sqlx::query::<sqlx::MySql>(query).bind(&self.comp_types_id).bind(&self.f_blob).bind(&self.f_date).bind(&self.f_datetime).bind(&self.f_json).bind(&self.f_timestamp).execute(executor).await?;
        Ok(result.rows_affected())
    }

    pub async fn upsert_batch<'e, E: sqlx::Executor<'e, Database = sqlx::MySql> + Clone>(executor: E, items: &[Self]) -> sqlx::Result<u64> {
        if items.is_empty() { return Ok(0); }
        let chunk_size = 65000 / 6;
        let mut total_affected = 0;
        for chunk in items.chunks(chunk_size.max(1)) {
            ...
            qb.push(" AS new_row ON DUPLICATE KEY UPDATE `comp_types_id` = new_row.`comp_types_id`, `f_blob` = new_row.`f_blob`, `f_date` = new_row.`f_date`, `f_datetime` = new_row.`f_datetime`, `f_json` = new_row.`f_json`, `f_timestamp` = new_row.`f_timestamp`");
            let result = qb.build().execute(executor.clone()).await?;
            total_affected += result.rows_affected();
        }
        Ok(total_affected)
    ...
    pub async fn delete_many_by_id<'e, E: sqlx::Executor<'e, Database = sqlx::MySql> + Clone>(executor: E, ids: &[i64]) -> sqlx::Result<u64> {
...
impl CompTypesTable {
    ...
    pub async fn upsert<'e, E: sqlx::Executor<'e, Database = sqlx::MySql>>(&self, executor: E) -> sqlx::Result<u64> {
        let query = "INSERT INTO comp_types_table (`f_bool`, `f_decimal`, `f_double`, `f_float`, `f_int`, `f_text`, `f_varchar`) VALUES (?, ?, ?, ?, ?, ?, ?) AS new_row ON DUPLICATE KEY UPDATE `f_bool` = new_row.`f_bool`, `f_decimal` = new_row.`f_decimal`, `f_double` = new_row.`f_double`, `f_float` = new_row.`f_float`, `f_int` = new_row.`f_int`, `f_text` = new_row.`f_text`, `f_varchar` = new_row.`f_varchar`";
        let result = sqlx::query::<sqlx::MySql>(query).bind(&self.f_bool).bind(&self.f_decimal).bind(&self.f_double).bind(&self.f_float).bind(&self.f_int).bind(&self.f_text).bind(&self.f_varchar).execute(executor).await?;
        Ok(result.rows_affected())
    }
    ...
    pub async fn upsert_batch<'e, E: sqlx::Executor<'e, Database = sqlx::MySql> + Clone>(executor: E, items: &[Self]) -> sqlx::Result<u64> {
        ...
        for chunk in items.chunks(chunk_size.max(1)) {
            ...
            qb.push(" AS new_row ON DUPLICATE KEY UPDATE `f_bool` = new_row.`f_bool`, `f_decimal` = new_row.`f_decimal`, `f_double` = new_row.`f_double`, `f_float` = new_row.`f_float`, `f_int` = new_row.`f_int`, `f_text` = new_row.`f_text`, `f_varchar` = new_row.`f_varchar`");
            let result = qb.build().execute(executor.clone()).await?;
            total_affected += result.rows_affected();
        }
        Ok(total_affected)
...
impl Configurations {
    ...
    pub async fn upsert<'e, E: sqlx::Executor<'e, Database = sqlx::MySql>>(&self, executor: E) -> sqlx::Result<u64> {
        let query = "INSERT INTO configurations (`match`, `type`, `value`) VALUES (?, ?, ?) AS new_row ON DUPLICATE KEY UPDATE `match` = new_row.`match`, `type` = new_row.`type`, `value` = new_row.`value`";
        let result = sqlx::query::<sqlx::MySql>(query).bind(&self.r#match).bind(&self.r#type).bind(&self.value).execute(executor).await?;
        Ok(result.rows_affected())
    }
    ...
    pub async fn upsert_batch<'e, E: sqlx::Executor<'e, Database = sqlx::MySql> + Clone>(executor: E, items: &[Self]) -> sqlx::Result<u64> {
        ...
        for chunk in items.chunks(chunk_size.max(1)) {
            ...
            qb.push(" AS new_row ON DUPLICATE KEY UPDATE `match` = new_row.`match`, `type` = new_row.`type`, `value` = new_row.`value`");
            let result = qb.build().execute(executor.clone()).await?;
            total_affected += result.rows_affected();
        }
        Ok(total_affected)
    ...
    pub async fn delete_many_by_id<'e, E: sqlx::Executor<'e, Database = sqlx::MySql> + Clone>(executor: E, ids: &[i32]) -> sqlx::Result<u64> {
        if ids.is_empty() { return Ok(0); }
        let mut total_affected = 0;
        for chunk in ids.chunks(500) {
...
impl Currencies {
    ...
    pub async fn get_by_code<'e, E: sqlx::Executor<'e, Database = sqlx::MySql>>(executor: E, code: &str) -> sqlx::Result<Option<Self>> {
        let query = "SELECT `code`, `name` FROM currencies WHERE `code` = ?";
        sqlx::query_as::<_, Self>(query).bind(code).fetch_optional(executor).await
    }

    pub async fn exists_by_code<'e, E: sqlx::Executor<'e, Database = sqlx::MySql>>(executor: E, code: &str) -> sqlx::Result<bool> {
    ...
    pub async fn list_by_cursor<'e, E: sqlx::Executor<'e, Database = sqlx::MySql>>(executor: E, last_id: &str, limit: u32) -> sqlx::Result<Vec<Self>> {
    ...
    pub async fn upsert<'e, E: sqlx::Executor<'e, Database = sqlx::MySql>>(&self, executor: E) -> sqlx::Result<u64> {
        let query = "INSERT INTO currencies (`code`, `name`) VALUES (?, ?) AS new_row ON DUPLICATE KEY UPDATE `name` = new_row.`name`";
        let result = sqlx::query::<sqlx::MySql>(query).bind(&self.code).bind(&self.name).execute(executor).await?;
        Ok(result.rows_affected())
    }
    ...
    pub async fn upsert_batch<'e, E: sqlx::Executor<'e, Database = sqlx::MySql> + Clone>(executor: E, items: &[Self]) -> sqlx::Result<u64> {
        ...
        for chunk in items.chunks(chunk_size.max(1)) {
            ...
            qb.push(" AS new_row ON DUPLICATE KEY UPDATE `name` = new_row.`name`");
            let result = qb.build().execute(executor.clone()).await?;
            total_affected += result.rows_affected();
        }
        Ok(total_affected)
    ...
    pub async fn delete_many_by_code<'e, E: sqlx::Executor<'e, Database = sqlx::MySql> + Clone>(executor: E, ids: &[String]) -> sqlx::Result<u64> {
        if ids.is_empty() { return Ok(0); }
        let mut total_affected = 0;
        for chunk in ids.chunks(500) {
    ...
    pub async fn update_partial_by_code<'e, E: sqlx::Executor<'e, Database = sqlx::MySql>>(executor: E, code: &str, patch: &CurrenciesPatch) -> sqlx::Result<u64> {
...
impl OrderItems {
    ...
    pub async fn upsert<'e, E: sqlx::Executor<'e, Database = sqlx::MySql>>(&self, executor: E) -> sqlx::Result<u64> {
        let query = "INSERT INTO order_items (`order_id`, `product_id`, `quantity`) VALUES (?, ?, ?) AS new_row ON DUPLICATE KEY UPDATE `quantity` = new_row.`quantity`";
        let result = sqlx::query::<sqlx::MySql>(query).bind(&self.order_id).bind(&self.product_id).bind(&self.quantity).execute(executor).await?;
        Ok(result.rows_affected())
    }
    ...
    pub async fn upsert_batch<'e, E: sqlx::Executor<'e, Database = sqlx::MySql> + Clone>(executor: E, items: &[Self]) -> sqlx::Result<u64> {
        ...
        for chunk in items.chunks(chunk_size.max(1)) {
            ...
            qb.push(" AS new_row ON DUPLICATE KEY UPDATE `quantity` = new_row.`quantity`");
            let result = qb.build().execute(executor.clone()).await?;
            total_affected += result.rows_affected();
        }
        Ok(total_affected)
...
impl ProductMetadata {
    ...
    pub async fn get_by_id<'e, E: sqlx::Executor<'e, Database = sqlx::MySql>>(executor: E, id: &[u8]) -> sqlx::Result<Option<Self>> {
        let query = "SELECT `attributes`, `category`, `id`, `raw_data` FROM product_metadata WHERE `id` = ?";
        sqlx::query_as::<_, Self>(query).bind(id).fetch_optional(executor).await
    }

    pub async fn exists_by_id<'e, E: sqlx::Executor<'e, Database = sqlx::MySql>>(executor: E, id: &[u8]) -> sqlx::Result<bool> {
        let query = "SELECT 1 FROM product_metadata WHERE `id` = ? LIMIT 1";
        let exists: Option<(i32,)> = sqlx::query_as(query).bind(id).fetch_optional(executor).await?;
        Ok(exists.is_some())
    }

    pub async fn list_by_cursor<'e, E: sqlx::Executor<'e, Database = sqlx::MySql>>(executor: E, last_id: &[u8], limit: u32) -> sqlx::Result<Vec<Self>> {
    ...
    pub async fn upsert<'e, E: sqlx::Executor<'e, Database = sqlx::MySql>>(&self, executor: E) -> sqlx::Result<u64> {
        let query = "INSERT INTO product_metadata (`attributes`, `category`, `id`, `raw_data`) VALUES (?, ?, ?, ?) AS new_row ON DUPLICATE KEY UPDATE `attributes` = new_row.`attributes`, `category` = new_row.`category`, `raw_data` = new_row.`raw_data`";
        let result = sqlx::query::<sqlx::MySql>(query).bind(&self.attributes).bind(&self.category).bind(&self.id).bind(&self.raw_data).execute(executor).await?;
        Ok(result.rows_affected())
    }
    ...
    pub async fn upsert_batch<'e, E: sqlx::Executor<'e, Database = sqlx::MySql> + Clone>(executor: E, items: &[Self]) -> sqlx::Result<u64> {
        ...
        for chunk in items.chunks(chunk_size.max(1)) {
            ...
            qb.push(" AS new_row ON DUPLICATE KEY UPDATE `attributes` = new_row.`attributes`, `category` = new_row.`category`, `raw_data` = new_row.`raw_data`");
            let result = qb.build().execute(executor.clone()).await?;
            total_affected += result.rows_affected();
        }
        Ok(total_affected)
    ...
    pub async fn delete_many_by_id<'e, E: sqlx::Executor<'e, Database = sqlx::MySql> + Clone>(executor: E, ids: &[Vec<u8>]) -> sqlx::Result<u64> {
        if ids.is_empty() { return Ok(0); }
        let mut total_affected = 0;
        for chunk in ids.chunks(500) {
    ...
    pub async fn update_partial_by_id<'e, E: sqlx::Executor<'e, Database = sqlx::MySql>>(executor: E, id: &[u8], patch: &ProductMetadataPatch) -> sqlx::Result<u64> {
...
impl UserRoles {
    ...
    pub async fn upsert<'e, E: sqlx::Executor<'e, Database = sqlx::MySql>>(&self, executor: E) -> sqlx::Result<u64> {
        let query = "INSERT INTO user_roles (`assigned_at`, `role_name`, `user_id`) VALUES (?, ?, ?) AS new_row ON DUPLICATE KEY UPDATE `assigned_at` = new_row.`assigned_at`";
        let result = sqlx::query::<sqlx::MySql>(query).bind(&self.assigned_at).bind(&self.role_name).bind(&self.user_id).execute(executor).await?;
        Ok(result.rows_affected())
    }
    ...
    pub async fn upsert_batch<'e, E: sqlx::Executor<'e, Database = sqlx::MySql> + Clone>(executor: E, items: &[Self]) -> sqlx::Result<u64> {
        ...
        for chunk in items.chunks(chunk_size.max(1)) {
            ...
            qb.push(" AS new_row ON DUPLICATE KEY UPDATE `assigned_at` = new_row.`assigned_at`");
            let result = qb.build().execute(executor.clone()).await?;
            total_affected += result.rows_affected();
        }
        Ok(total_affected)
...
impl Users {
    ...
    pub async fn upsert<'e, E: sqlx::Executor<'e, Database = sqlx::MySql>>(&self, executor: E) -> sqlx::Result<u64> {
        let query = "INSERT INTO users (`created_at`, `email`, `first_name`, `last_name`, `status`) VALUES (?, ?, ?, ?, ?) AS new_row ON DUPLICATE KEY UPDATE `created_at` = new_row.`created_at`, `email` = new_row.`email`, `first_name` = new_row.`first_name`, `last_name` = new_row.`last_name`, `status` = new_row.`status`";
        let result = sqlx::query::<sqlx::MySql>(query).bind(&self.created_at).bind(&self.email).bind(&self.first_name).bind(&self.last_name).bind(&self.status).execute(executor).await?;
        Ok(result.rows_affected())
    }
    ...
    pub async fn upsert_batch<'e, E: sqlx::Executor<'e, Database = sqlx::MySql> + Clone>(executor: E, items: &[Self]) -> sqlx::Result<u64> {
        ...
        for chunk in items.chunks(chunk_size.max(1)) {
            ...
            qb.push(" AS new_row ON DUPLICATE KEY UPDATE `created_at` = new_row.`created_at`, `email` = new_row.`email`, `first_name` = new_row.`first_name`, `last_name` = new_row.`last_name`, `status` = new_row.`status`");
            let result = qb.build().execute(executor.clone()).await?;
            total_affected += result.rows_affected();
        }
        Ok(total_affected)
